...
| --- | --- |
| Does the accounting have stateful coverage? | 199 Foundry tests, including 16 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (199/199 at the time of writing — 183 unit
