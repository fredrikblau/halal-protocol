...
| --- | --- |
| Does the accounting have stateful coverage? | 196 Foundry tests, including 11 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (196/196 at the time of writing — 185 unit
