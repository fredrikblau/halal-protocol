...
- **Full Test Suite** - 199 tests (188 ordinary tests plus 11 stateful PSM invariants) covering the core workflows
...
# ... (199 tests: 188 ordinary + 11 invariants) ...
```
...
- `contracts/test/` — 199 tests (188 ordinary tests plus 11 stateful PSM invariants) and fixtures
