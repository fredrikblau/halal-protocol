...
- **Full Test Suite** - 199 tests (183 unit/configuration tests plus 16 stateful PSM invariants) covering the core workflows
...
# ... (199 tests: 183 unit/configuration + 16 invariants) ...
```
...
- `contracts/test/` — 199 tests (183 unit/configuration tests plus 16 stateful PSM invariants) and fixtures
