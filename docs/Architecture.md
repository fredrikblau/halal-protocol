...
```
Foundry test suite (200 tests: 184 unit/configuration + 16 stateful invariants)
...
| `contracts/test/` | 200 tests (184 unit/configuration + 16 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (200/200 should pass)
