...
```
Foundry test suite (197 tests: 184 unit/configuration + 13 stateful invariants)
...
| `contracts/test/` | 197 tests (184 unit/configuration + 13 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (197/197 should pass)
