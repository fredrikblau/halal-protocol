...
```
Foundry test suite (199 tests: 188 unit/configuration + 11 stateful invariants)
...
| `contracts/test/` | 199 tests (188 unit/configuration + 11 stateful PSM invariants) and fixtures |
